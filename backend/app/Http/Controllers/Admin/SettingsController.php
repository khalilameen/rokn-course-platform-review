...
class SettingsController extends Controller
{
    ...
    public function update(Request $request)
    {
        try {
            ...
            'how_to_use_coins_ar' => 'nullable|string|max:3000',
            'how_to_use_coins_en' => 'nullable|string|max:3000',
            'welcome_bonus_coins' => 'required|integer|min:0|max:100000',
            ...
            'daily_reward_coins' => 'required|integer|min:0|max:100000',
            'daily_reward_rolling_30_day_cap' => 'required|integer|min:0|max:1000000',
            'study_reward_coins' => 'required|integer|min:0|max:100000',
            'study_reward_minutes' => 'required|integer|min:1|max:1440',
            'study_reward_daily_cap' => 'required|integer|min:0|max:1000000',
            'study_reward_rolling_30_day_cap' => 'required|integer|min:0|max:1000000',
            'first_project_reward_coins' => 'required|integer|min:0|max:1000000',
            'course_completion_reward_coins' => 'required|integer|min:0|max:1000000',
            'course_completion_rolling_30_day_cap' => 'required|integer|min:0|max:1000000',
