                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="lesson_title_ar" name="lesson_title_ar" class="form-control"
                                       value="{{ old('lesson_title_ar', $lesson->title_ar ?? $lesson->title ?? '') }}" placeholder="أدخل عنوان الدرس بالعربية" data-required="true">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="lesson_title_en" name="lesson_title_en" class="form-control"
                                       value="{{ old('lesson_title_en', $lesson->title_en ?? '') }}" placeholder="Enter English lesson title">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <textarea id="lesson_description_ar" name="lesson_description_ar" class="form-control" rows="4"
                                          placeholder="أدخل وصف الدرس بالعربية">{{ old('lesson_description_ar', $lesson->description_ar ?? $lesson->description ?? '') }}</textarea>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
