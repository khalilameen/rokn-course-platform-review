                ...
                <div class="form-section dynamic-form" id="link-form" data-type="link">
                    ...
                    @php
                        $link = $section->getSectionType() == 'link' ? $section->sectionable : null;
                    @endphp
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="link_title_ar" name="link_title_ar" class="form-control"
                                       value="{{ old('link_title_ar', $link->title_ar ?? '') }}" placeholder="أدخل العنوان بالعربية" data-required="true">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="link_title_en" name="link_title_en" class="form-control"
                                       value="{{ old('link_title_en', $link->title_en ?? '') }}" placeholder="Enter English title" data-required="true">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="url" id="link_url" name="link_url" class="form-control"
                               value="{{ old('link_url', $link->link ?? '') }}" placeholder="https://..." data-required="true">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select id="link_type" name="link_type" class="form-select" data-required="true">
                            ...
                            <option value="resource" {{ old('link_type', $link->type ?? '') == 'resource' ? 'selected' : '' }}>مورد تعليمي</option>
                            <option value="video" {{ old('link_type', $link->type ?? '') == 'video' ? 'selected' : '' }}>فيديو</option>
                            <option value="document" {{ old('link_type', $link->type ?? '') == 'document' ? 'selected' : '' }}>مستند</option>
                            <option value="website" {{ old('link_type', $link->type ?? '') == 'website' ? 'selected' : '' }}>موقع ويب</option>
                        </select>
                    </div>
                </div>
