                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="course_name_ar" name="course_name_ar" class="form-control"
                                       value="{{ old('course_name_ar') }}" placeholder="أدخل اسم الكورس بالعربية" data-required="true">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="course_name_en" name="course_name_en" class="form-control"
                                       value="{{ old('course_name_en') }}" placeholder="Enter course name in English"  data-required="true">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <textarea id="course_description_ar" name="course_description_ar" class="form-control" rows="3"
                                          placeholder="أدخل وصف الكورس بالعربية">{{ old('course_description_ar') }}</textarea>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <textarea id="course_description_en" name="course_description_en" class="form-control" rows="3"
                                          placeholder="Enter course description in English">{{ old('course_description_en') }}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select id="course_grade_id" name="course_grade_id" class="form-select" data-required="true">
                            ...
                            @foreach(\App\Models\Grade::all() as $grade)
                                <option value="{{ $grade->id }}" {{ old('course_grade_id') == $grade->id ? 'selected' : '' }}>
                                    {{ $grade->name_ar }}
                                </option>
                            @endforeach
                        </select>
