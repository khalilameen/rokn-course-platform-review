                ...
                <div class="form-section dynamic-form" id="quiz-form" data-type="quiz">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="quiz_title_ar" name="quiz_title_ar" class="form-control"
                                       value="{{ old('quiz_title_ar') }}" placeholder="أدخل عنوان الاختبار بالعربية" data-required="true">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="quiz_title_en" name="quiz_title_en" class="form-control"
                                       value="{{ old('quiz_title_en') }}" placeholder="Enter English quiz title">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <textarea id="quiz_description_ar" name="quiz_description_ar" class="form-control" rows="4"
                                          placeholder="أدخل وصف الاختبار بالعربية">{{ old('quiz_description_ar') }}</textarea>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <textarea id="quiz_description_en" name="quiz_description_en" class="form-control" rows="4"
                                          placeholder="Enter English quiz description">{{ old('quiz_description_en') }}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="time_minutes" name="time_minutes" class="form-control"
                               value="{{ old('time_minutes') }}" placeholder="أدخل مدة الاختبار بالدقائق" min="1" data-required="true">
                    ...
                    <div class="mb-3">
                        ...
                        <button type="button" id="addQuestionBtn" class="btn-modern add-question-btn--success mt-3">
