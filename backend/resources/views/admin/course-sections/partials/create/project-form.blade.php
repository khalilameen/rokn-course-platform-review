                ...
                <div class="form-section dynamic-form" id="project-form" data-type="project">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="ai_prompt" class="form-control" rows="5" placeholder="اكتب التعليمات للذكاء الاصطناعي لتقييم المشروع (مثال: قيم الكود بناء على المعايير التالية...)" data-required="true">{{ old('ai_prompt') }}</textarea>
