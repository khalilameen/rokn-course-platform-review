    ...
    <div class="design-card">
        <form action="{{ route('admin.design-settings.store') }}" method="POST" enctype="multipart/form-data" id="designSettingsForm">
            ...
            <div class="accordion-design">
                ...
                <div class="accordion-item-design">
                    <div class="accordion-header-design">
                        <button type="button" class="accordion-button-design" onclick="toggleAccordion(this, 'social')">
                            <div class="icon-circle">
                    ...
                    <div class="accordion-content-design" id="social">
                        <div class="accordion-body-design">
                            <div class="form-row-design">
                                <div class="form-group-design">
                                    <label class="form-label-design">
                                    ...
                                    <input type="url" name="facebook_url" class="form-control-design"
                                ...
                                <div class="form-group-design">
                                    ...
                                    <input type="url" name="youtube_url" class="form-control-design"
                            ...
                            <div class="form-row-design">
                                <div class="form-group-design">
                                    ...
                                    <input type="url" name="instagram_url" class="form-control-design"
                                ...
                                <div class="form-group-design">
                                    ...
                                    <input type="url" name="tiktok_url" class="form-control-design"
                                           value="{{ $settings->tiktok_url }}" placeholder="https://tiktok.com/@...">
                                </div>
                            </div>
                            ...
                            <div class="form-row-design">
                                <div class="form-group-design">
                                    ...
                                    <input type="url" name="whatsapp_url" class="form-control-design"
                                           value="{{ $settings->whatsapp_url }}" placeholder="https://wa.me/...">
                                </div>
                                ...
                                <div class="form-group-design">
                                    ...
                                    <input type="url" name="telegram_url" class="form-control-design"
