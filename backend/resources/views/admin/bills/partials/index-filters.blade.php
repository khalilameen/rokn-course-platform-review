                    ...
                    <form method="GET" action="{{ route('admin.bills.index') }}">
                        <div class="row">
                            <div class="col-md-3 mb-3">
                                ...
                                <select name="payment_status" class="form-control filter-control">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                <label class="filter-label">من تاريخ الاستحقاق</label>
                                <input type="date" name="due_date_from" class="form-control filter-control" value="{{ request('due_date_from') }}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label class="filter-label">إلى تاريخ الاستحقاق</label>
                                <input type="date" name="due_date_to" class="form-control filter-control" value="{{ request('due_date_to') }}">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-3 mb-3">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <a href="{{ route('admin.bills.index') }}" class="btn btn-reset-filter">
