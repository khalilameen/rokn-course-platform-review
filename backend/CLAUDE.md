...
Rokn is a **single-tenant** e-learning mobile app backend (dashboard + APIs) built with Laravel 12 and PHP 8.2. It provides course access, learning progress, projects, exams, certificates, payments, notifications and administration functionality.
