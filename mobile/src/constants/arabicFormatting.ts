...
const LEARNING_TERM_REPLACEMENTS: ReadonlyArray<readonly [RegExp, string]> = [
  [/(^|[^\u0621-\u064A])الريلز(?=$|[^\u0621-\u064A])/g, '$1الخطوات'],
  [/(^|[^\u0621-\u064A])ريلز(?=$|[^\u0621-\u064A])/g, '$1خطوات'],
  [/(^|[^\u0621-\u064A])الريلات(?=$|[^\u0621-\u064A])/g, '$1الخطوات'],
  [/(^|[^\u0621-\u064A])ريلات(?=$|[^\u0621-\u064A])/g, '$1خطوات'],
  [/(^|[^\u0621-\u064A])الريلين(?=$|[^\u0621-\u064A])/g, '$1الخطوتين'],
  [/(^|[^\u0621-\u064A])ريلين(?=$|[^\u0621-\u064A])/g, '$1خطوتين'],
  [/(^|[^\u0621-\u064A])الريل(?=$|[^\u0621-\u064A])/g, '$1الخطوة'],
  [/(^|[^\u0621-\u064A])ريلًا(?=$|[^\u0621-\u064A])/g, '$1خطوة'],
  [/(^|[^\u0621-\u064A])ريلاً(?=$|[^\u0621-\u064A])/g, '$1خطوة'],
  [/(^|[^\u0621-\u064A])ريل(?=$|[^\u0621-\u064A])/g, '$1خطوة'],
];
