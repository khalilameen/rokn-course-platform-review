...
const PRINCIPLES = [
  {
    index: '٠١',
    title: 'خطوة قصيرة بدل محاضرة طويلة',
    description:
      'كل خطوة تعلّمك فكرة واحدة بوضوح، لتتقدم حتى في الدقائق الصغيرة من يومك.',
  },
  {
    index: '٠٢',
          ...
          <PremiumCard style={[styles.hero, isTablet && styles.heroTablet]}>
            ...
            <View style={styles.heroCopy}>
              ...
              <Text style={styles.heroDescription}>
                ...
                كورسات من خطوات قصيرة مترابطة، ومشاريع تثبت ما تعلّمته، ومسار واضح حتى
