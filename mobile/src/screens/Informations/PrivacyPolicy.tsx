...
const SECTIONS = [
  ...
  },
  {
    ...
    body: 'نسجل العملات المدفوعة وعملات المكافآت في رصيدين منفصلين حتى لو ظهر لك الإجمالي في المحفظة. يعالج Kashier الدفع، وتستقبل ركن مرجع العملية وقيمتها وحالتها اللازمة لإضافة الرصيد وحل المشكلات. لا تخزن ركن رقم البطاقة الكامل أو رمز الأمان.',
  },
  {
    number: '٠٧',
    title: 'Rokn AI',
  ...
  },
  {
    ...
    body: 'لا نبيع بياناتك أو نؤجرها. نشارك الحد الضروري مع مزودي تسجيل الدخول، وKashier للدفع، وBunny لتخزين وتوصيل الفيديو والصور والملفات، وOpenRouter ومزودي النماذج، وخدمات التشغيل والدعم، والمدرب أو المراجع عند مراجعة مشروعك، أو جهة مختصة عندما يلزم القانون.',
  },
  {
    number: '٠٩',
    title: 'البورتفوليو والشهادات',
    body: 'تظل أعمالك ملكك. ما تختار نشره في البورتفوليو يصبح متاحًا عبر رابطه العام، ويمكن أن يفتح رمز QR في الشهادة صفحة التحقق أو البورتفوليو. لا نعرض بريدك أو رقم هاتفك في الصفحة العامة إلا إذا اخترت إضافتهما بوضوح.',
  },
  {
    number: '١٠',
        ...
        <ResponsiveFrame>
          ...
          <PremiumCard style={styles.summary}>
            ...
            <View style={styles.summaryCopy}>
              ...
              <Text style={styles.updated}>آخر تحديث: ٦ أغسطس ٢٠٢٦</Text>
            </View>
          </PremiumCard>
