...
export const ECONOMY_RULES = [
  'رصيد ركن مخصص لفتح الكورسات داخل التطبيق، وليس نقودًا أو أصلًا رقميًا.',
  'الرصيد المدفوع والمكافآت منفصلان في السجل، ويظهر مجموعهما فقط في واجهة المحفظة.',
  'عند فتح كورس نستخدم المكافآت أولًا، ثم الرصيد المدفوع.',
  'رصيد المكافآت له حد أقصى ١٢٠٠، لذلك لا يفتح وحده كورسًا مدفوعًا.',
  'لا يمكن تحويل الرصيد بين الحسابات أو استبداله بنقد.',
  'لا يُخصم شيء إذا لم تكتمل عملية فتح الكورس.',
] as const;
